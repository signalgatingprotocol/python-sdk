from examples.incident_triage import run_scenario


async def test_incident_triage_quantifies_context_reduction() -> None:
    ...
    assert result.context_reduction_percent == 75.0
